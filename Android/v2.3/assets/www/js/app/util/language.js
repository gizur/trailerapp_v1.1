...
var Language = Stapes.subclass({
    constructor : function( language, aLogConfig ) {
        ...
        this.set( 'svenska' , {
                ...
                'All fields (Email, Password and Gizur Saas ClientID) must be filled' : 'Alla fält (Email, lösenord och Gizur Saas ClientID) behöver fyllas ',
                ...
                'Please enter a valid client id' : 'Ange ett giltigt klient id',
                'There are no damage to report' : 'Det finns ingen skada att rapportera',
                ...
                'View More' : 'Se ytterligare',
                'Loading more' : 'Laddar skador',
                'Message' : 'meddelande',
                'Close' : 'Stäng',
                'An account needs to setup in order to use this service. Please contact' : 'Ett konto måste sättas upp för att använda den här tjänsten. Kontakta',
                'in order to setup an account' : 'för att få ett konto.',
                'Provided client ID is not valid' : 'Förutsatt klient-ID är inte giltigt',
                'Please provide a valid username and try again.' : 'Ange ett giltigt användarnamn och försök igen.',
                'Error while reporting damages. Please try again, If the problem persists please contact the Gizur Saas Account holders' : 'Fel vid anmälningen skadestånd. Försök igen, om problemet kvarstår kontakta Gizur Saas kontoinnehavare'
        });
