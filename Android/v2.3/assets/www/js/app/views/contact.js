...
var ScreenContactView = Stapes.subclass({
    ...
    constructor : function(aLog, aWrapper, aLanguage) {
    ...
    render : function() {
        ...
        try {
            ...
            if (contact_html === null) {
                ...
                $('#contacts-box').html('<div><p>' + this._language.translate('An account needs to setup in order to use this service. Please contact')
                .concat(' <a href="mailto://sales@gizur.com">sales@gizur.com</a> ' ,
                this._language.translate('in order to setup an account'))+'</p></div>');
            } else {
            	$('#contacts-box').empty();
