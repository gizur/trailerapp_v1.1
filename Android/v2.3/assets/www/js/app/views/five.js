...
var ScreenFiveView = Stapes.subclass({
    ...
    bindEventHandlers : function() {
        ...
        $('#five #sendalldamages').unbind('click').click(function(){
        	//alert($('.bxslider-five-b').find('li').html() == );
        	if($('.bxslider-five-b').find('li').html() == that._language.translate("No Damages Reported") ){
        		that._wrapper.showAlert(that._language.translate("There are no damage to report"), that._language.translate("Message"));
                return false;
        		}
        ...
        $('#five .bxslider-five-b').unbind('click').click(function(e){
        	$('.bxslider-five-b').find('li').each(function(){
        		
            	if($(this).html()===that._language.translate("No Damages Reported"))
            		{
            		
            		
            		that._wrapper.showAlert(that._language.translate("No Damages Reported"), that._language.translate("Message"));
                    return false;
